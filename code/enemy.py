...
class Enemy(Entity):
    ...
    def import_graphics(self, name):
        ...
        assets_path = f'../graphics/monsters/{name}/'
        
        for animation in self.animations.keys():
            self.animations[animation] = import_folder(assets_path + animation)
            
    def get_chase_vector(self, player):
    ...
    def get_status(self, player):
        distance = self.get_chase_vector(player)[0]
