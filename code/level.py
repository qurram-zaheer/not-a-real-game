...
class Level:
    ...
    def create_map(self):
        ...
        graphics = {
            ...
            # 'entities': import_folder('../graphics/monsters')
        }
            ...
            for row_idx, row in enumerate(layout):
                for col_idx, col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'grass':
                            Tile((x, y), [self.visible_sprites, self.obstacle_sprites, self.attackable_sprites], 'grass', choice(
                                graphics['grass']))
    ...
    def create_cast(self, style, strength, cost):
        if style == 'heal':
